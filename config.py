                    ...
                    if sps != {}:
                        for sp_name, sp_dict in sps.items():
                            ...
                            if web_dict == {}:
                                ...
                                sp._dependencies_html_url = web_dict.get('sbomdepsurl')
                                ...
                                sp._web_spdx = web_dict.get('spdx', "")
    ...
    def default(self, o): # pylint: disable=method-hidden
        if isinstance(o, Config):
            ...
            if o._repotype == ProjectRepoType.GITHUB:
                ...
                if o._dependencies_html_url != "":
                    js["web"]["sbomdepsurl"] = o._dependencies_html_url
                if o._web_xlsx_url != "":
