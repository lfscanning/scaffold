...
* `reports-private`: if true, publish the SBOMs and SPDX file generated by FOSSology to the report server rather than pushing to the public lfscanning git repository
