...
from scaffold.config import loadConfig, saveBackupConfig, saveConfig, isInThisCycle, updateFossologyToken
from scaffold import datefuncs
from scaffold.runners import doNextThing
from scaffold.manualws import runManualWSAgent
from scaffold.manualsbom import runManualSbomAgent
from scaffold.clearing import doCleared
from scaffold.newmonth import copyToNextMonth
from scaffold.approving import doApprove
from scaffold.emailing import printEmail, printAllLinks, printReportLinks
from scaffold.delivering import doDelivered
from scaffold.metrics import getMetrics, printMetrics
from scaffold.metricsfile import saveMetrics
from scaffold.transfer import doTransfer
...
Commands:
  ...
  Manual run:
    ...
    sbom:             Manually run a dependency scan and generate an SBOM
