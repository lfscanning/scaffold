...
def printAllLinksForSubproject(cfg, prj, sp):
    ...
    print(f"  - spdx:        https://github.com/{cfg._spdx_github_org}/{spdxRepoName}/tree/main/{sp._name}/{cfg._month}/{sp._name}-{sp._code_pulled}.spdx")
    if sp._web_sbom_url:
        print(f"  - sbom xlsx:   {sp._web_sbom_url}")
        print(f"  - sbom json:   https://github.com/{cfg._spdx_github_org}/{spdxRepoName}/tree/main/{sp._name}/{cfg._month}/{prj._name}-{sp._name}-spdx.json")
    print(f"")
